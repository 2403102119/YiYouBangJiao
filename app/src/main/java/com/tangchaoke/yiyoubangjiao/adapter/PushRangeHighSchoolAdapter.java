...
public class PushRangeHighSchoolAdapter extends RecyclerView.Adapter<PushRangeHighSchoolAdapter.MyViewHold> {

    private LayoutInflater mLayoutInflater;
    private Context mContext;
    List<PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangeHighSchoolModel> mList;

    public PushRangeHighSchoolAdapter(Context mContext,
                                      List<PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangeHighSchoolModel> mList) {
    ...
    public void onBindViewHolder(MyViewHold holder, int position) {
        PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangeHighSchoolModel mHomeMode12CharacterModel =
                mList.get(position);
