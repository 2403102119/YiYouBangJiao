...
public class FindTeacherSmallPopAdapter extends RecyclerView.Adapter<FindTeacherSmallPopAdapter.MyViewHold> {
    ...
    public FindTeacherSmallPopAdapter(int mSelectedPos, Context mContext, List<String> mGradeList, OnItemClickListener mOnItemClickListener) {
