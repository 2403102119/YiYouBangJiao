...
public class PrimarySchoolGradeAdapter extends RecyclerView.Adapter<PrimarySchoolGradeAdapter.MyViewHold> {
    ...
    public PrimarySchoolGradeAdapter(Context mContext, List<String> mGradeList, OnItemClickListener mOnItemClickListener) {
