...
public class PushRangeInfoAdapter extends RecyclerView.Adapter<PushRangeInfoAdapter.MyViewHold> {

    private LayoutInflater mLayoutInflater;
    private Context mContext;
    List<PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangePrimarySchoolModel> mList;

    public PushRangeInfoAdapter(Context mContext,
                                List<PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangePrimarySchoolModel> mList) {
    ...
    public void onBindViewHolder(MyViewHold holder, int position) {
        PushRangeInfoModel.PushRangeInfoRangeModel.PushRangeInfoRangePrimarySchoolModel mHomeMode12CharacterModel =
                mList.get(position);
