...
public class PrimarySchoolSubjectAdapter extends RecyclerView.Adapter<PrimarySchoolSubjectAdapter.MyViewHold> {
    ...
    public PrimarySchoolSubjectAdapter(Context mContext, List<String> mList, OnItemClickListener mOnItemClickListener) {
