...
public class HelpUnAnsweredAdapter extends RecyclerView.Adapter<HelpUnAnsweredAdapter.MyViewHold> {
    ...
    public HelpUnAnsweredAdapter(Context mContext, List<ProblemBean.ProblemModelBean> mList, OnItemClickListener mOnItemClickListener) {
