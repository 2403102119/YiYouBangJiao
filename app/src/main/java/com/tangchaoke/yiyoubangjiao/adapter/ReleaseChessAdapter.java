...
public class ReleaseChessAdapter extends RecyclerView.Adapter<ReleaseChessAdapter.MyViewHold> {
    ...
    public ReleaseChessAdapter(int mSelectedPos, Context mContext, List<String> mSubjectList, OnItemClickListener mOnItemClickListener) {
