...
public class FindTeacherPopSubjectAdapter extends RecyclerView.Adapter<FindTeacherPopSubjectAdapter.MyViewHold> {
    ...
    public FindTeacherPopSubjectAdapter(int mSelectedPos, Context mContext, List<String> mGradeList, OnItemClickListener mOnItemClickListener) {
    ...
    public MyViewHold onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHold(mLayoutInflater.inflate(R.layout.item_find_teacher_subject, parent, false));
    }
    ...
    public void onBindViewHolder(MyViewHold holder, int position, List<Object> payloads) {
        ...
        if (payloads.isEmpty()) {
            ...
            if (mSelectedPos == position) {
                holder.mLlOnclick.setBackgroundResource(R.drawable.shape_light_blue_fillet_square);
