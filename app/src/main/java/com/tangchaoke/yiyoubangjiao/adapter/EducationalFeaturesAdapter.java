...
public class EducationalFeaturesAdapter extends RecyclerView.Adapter<EducationalFeaturesAdapter.MyViewHold> {
    ...
    public EducationalFeaturesAdapter(Context mContext, List<String> mList, OnItemClickListener mOnItemClickListener) {
