...
public class HighSchoolGradeAdapter extends RecyclerView.Adapter<HighSchoolGradeAdapter.MyViewHold> {
    ...
    public HighSchoolGradeAdapter(Context mContext, List<String> mGradeList, OnItemClickListener mOnItemClickListener) {
