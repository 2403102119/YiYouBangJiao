...
public class AnswerPopChessAdapter extends RecyclerView.Adapter<AnswerPopChessAdapter.MyViewHold> {
    ...
    public AnswerPopChessAdapter(int mSelectedPos, Context mContext, List<String> mGradeList, OnItemClickListener mOnItemClickListener) {
    ...
    public MyViewHold onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHold(mLayoutInflater.inflate(R.layout.item_answer_pop_chess, parent, false));
    }
