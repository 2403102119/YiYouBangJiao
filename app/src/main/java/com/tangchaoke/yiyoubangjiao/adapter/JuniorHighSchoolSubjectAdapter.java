...
public class JuniorHighSchoolSubjectAdapter extends RecyclerView.Adapter<JuniorHighSchoolSubjectAdapter.MyViewHold> {
    ...
    public JuniorHighSchoolSubjectAdapter(Context mContext, List<String> mList, OnItemClickListener mOnItemClickListener) {
