...
public class ClubCityAdapter extends RecyclerView.Adapter<ClubCityAdapter.MyViewHold> {

    private LayoutInflater mLayoutInflater;
    private Context mContext;
    private OnItemClickListener mOnItemClickListener;
    List<ClubProvinceInfoModel.ClubProvinceInfoListModel.ClubProvinceInfoCityListModel> mListCity;
    ...
    public ClubCityAdapter(int mSelectProvincePos, int mSelectCityPos, Context mContext,
                           List<ClubProvinceInfoModel.ClubProvinceInfoListModel.ClubProvinceInfoCityListModel> mListCity,
    ...
    public void onBindViewHolder(MyViewHold holder, int position, List<Object> payloads) {
        ...
        holder.mTvClubName.setText(mListCity.get(position).getName());
