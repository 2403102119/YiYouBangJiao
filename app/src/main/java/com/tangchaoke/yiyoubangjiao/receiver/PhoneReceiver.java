...
public class PhoneReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_NEW_OUTGOING_CALL)) {
            ...
            Log.d("==接打电话:::", "call OUT:" + phoneNumber);
        } else {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_IDLE:
                    ...
                    Log.e("==接打电话:::", "call OUT:挂断");
                    break;
                case TelephonyManager.CALL_STATE_OFFHOOK:
                    System.out.println("接听");
                    Log.e("==接打电话:::", "call OUT:接听");
                    LocalBroadcastManager localBroadcastManager = LocalBroadcastManager.getInstance(mContext);
                    Intent intent = new Intent("com.tangchaoke.yiyoubangjiao.voice");
                    intent.putExtra("tuisong", "phone");
                    localBroadcastManager.sendBroadcast(intent);//发送本地广播。
                    break;
                case TelephonyManager.CALL_STATE_RINGING:
                    System.out.println("响铃:来电号码" + incomingNumber);
                    Log.e("==接打电话:::", "call OUT:响铃:来电号码" + incomingNumber);
                    //输出来电号码
                    break;
            }
        }
