...
*/
public class UpDatedDialogView extends Dialog {
    ...
    TextView mDialogButYes;

    @BindView(R.id.dialog_but_no)
    TextView mDialogButNo;
    ...
    public UpDatedDialogView(Context context) {
        this(context, mTheme);
    }

    public UpDatedDialogView(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_up_dated);
