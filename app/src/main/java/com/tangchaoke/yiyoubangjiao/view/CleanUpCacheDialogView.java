...
public class CleanUpCacheDialogView extends Dialog implements View.OnClickListener {
    ...
    public CleanUpCacheDialogView(Context context) {
        this(context, mTheme);
    }

    public CleanUpCacheDialogView(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_clean_up_cache);
