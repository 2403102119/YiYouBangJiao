...
* @author hg
* @create at 2018/3/14
* @description 输入文本框Dialog
*/
public class InputBoxDialogView extends Dialog {
    private static int mTheme = R.style.CustomDialog;//自定义dialog样式

    private static final int MSG_SET_CONTENT_INPUT_BOX = 0x10;//设置内容文字
    private static final int MSG_SET_CONTENT_COLOR_INPUT_BOX = 0x11;//设置内容文字颜色
    private static final int MSG_SET_TITLE_CONTENT_COLOR_INPUT_BOX = 0x02;//设置标题及内容文字的颜色
    private static final int MSG_SET_CONTENT = 0x20;//设置内容文字
    private static final int MSG_SET_CONTENT_HINT = 0x23;//设置内容文字
    ...
    @BindView(R.id.tv_input_box)
    TextView mTvInputBox;

    @BindView(R.id.dialog_tv_title)
    EditText mDialogTvTitle;
    ...
    public InputBoxDialogView(Context context) {
        this(context, mTheme);
    }

    public InputBoxDialogView(Context context, int themeResId) {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_SET_CONTENT_INPUT_BOX:
                    mTvInputBox.setText((String) msg.obj);
                    break;
                case MSG_SET_CONTENT_COLOR_INPUT_BOX:
                    mTvInputBox.setTextColor(msg.arg1);
                    break;
                case MSG_SET_TITLE_CONTENT_COLOR_INPUT_BOX:
                    mTvInputBox.setTextColor(msg.arg1);
                    break;
                case MSG_SET_CONTENT:
                    mDialogTvTitle.setText((String) msg.obj);
                    break;
                case MSG_SET_CONTENT_HINT:
                    mDialogTvTitle.setHint((String) msg.obj);
                    break;
     ...
     * @param content
     */
    public void setContentInputBox(String content) {
        Message msg = mHandler.obtainMessage();
        msg.what = MSG_SET_CONTENT_INPUT_BOX;
        msg.obj = content;
     ...
     * @param colorId
     */
    public void setContentColorInputBox(int colorId) {
        Message msg = mHandler.obtainMessage();
        msg.what = MSG_SET_CONTENT_COLOR_INPUT_BOX;
        msg.arg1 = colorId;
        mHandler.sendMessage(msg);
    }
     ...
     * @param colorId
     */
    public void setTitleContentColorInputBox(int colorId) {
        Message msg = mHandler.obtainMessage();
        msg.what = MSG_SET_TITLE_CONTENT_COLOR_INPUT_BOX;
        msg.arg1 = colorId;
        mHandler.sendMessage(msg);
    }
    ...
    public void setHint(String content) {
        Message msg = mHandler.obtainMessage();
        msg.what = MSG_SET_CONTENT_HINT;
        msg.obj = content;
        mHandler.sendMessage(msg);
    }

    public String getText() {
        String content = mDialogTvTitle.getText().toString();
        return content;
    }
