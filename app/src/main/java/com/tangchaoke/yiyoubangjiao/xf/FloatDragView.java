package com.tangchaoke.yiyoubangjiao.xf;
...
/**
 * @ClassName: FloatDragVie * @Description: 可拖动的悬浮按钮
 * @Author: HG
 * @Date：2016/3/18
 */
public class FloatDragView {
     ...
     */
    public static Button addFloatDragView(Activity context, RelativeLayout mViewContainer,
                                          View.OnClickListener clickListener) {
        FloatDragView floatDragView = new FloatDragView(context);
        Button mButton = floatDragView.getFloatDragButtonView(clickListener);
        mViewContainer.addView(mButton);
        return mButton;
    }
    ...
    // 获取可拖动按钮的实例
    private Button getFloatDragButtonView(View.OnClickListener clickListener) {
        if (mButton != null) {
            return mButton;
        } else {
            ...
            mButton.setText("原题\n再现");
            mButton.setTextColor(context.getResources().getColor(R.color.colorPrimary));
            mButton.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.shape_light_blue_circle));
            setFloatDragViewParams(mButton);
            mButton.setOnClickListener(clickListener);
            setFloatDragViewButtonTouch(mButton);
            return mButton;
        }
    }
    ...
    // 可拖动按钮的touch事件
    private void setFloatDragViewButtonTouch(final Button floatDragView) {
